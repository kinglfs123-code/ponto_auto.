/**
 * Estrutura de categorias do DRE — réplica fiel da planilha "DRE_p_automação.xlsx".
 *
 * Convenções:
...
export interface DreCategory {
  ...
  formula?: string[];
  /** Indenta visualmente: 0 = título de seção, 1 = item. */
  indent?: 0 | 1;
}

// Helpers
const sub = (code: string, label: string, formula: string[]): DreCategory => ({
  code,
  label,
  sign: "=",
  is_subtotal: true,
...
export const DRE_CATEGORIES: DreCategory[] = [
  // 1.00 Receita Bruta
  sub("1.00", "Receita Bruta", ["1.01", "1.02", "1.03", "1.04", "1.05", "1.06"]),
  { code: "1.01", label: "Vendas Varejo", sign: "+", indent: 1 },
  { code: "1.02", label: "Vendas Empresas", sign: "+", indent: 1 },
  { code: "1.03", label: "Outras Receitas Operacionais", sign: "+", indent: 1 },
  { code: "1.04", label: "Receitas — Linha 4", sign: "+", indent: 1 },
  { code: "1.05", label: "Receitas — Linha 5", sign: "+", indent: 1 },
  { code: "1.06", label: "Receitas — Linha 6", sign: "+", indent: 1 },

  // 2.00 Deduções
  sub("2.00", "Deduções de Vendas (var)", ["2.01", "2.02"]),
  { code: "2.01", label: "Devoluções", sign: "-", indent: 1 },
  { code: "2.02", label: "Perdas de Inadimplência", sign: "-", indent: 1 },

  // 3.00 Receita Líquida
  sub("3.00", "Receita Líquida (1 − 2)", ["1.00", "-2.00"]),

  // 4.00 Impostos sobre Vendas
  sub("4.00", "Impostos sobre Vendas (var)", [
    "201", "4.02", "4.03", "4.04", "4.05", "4.06", "4.07",
  ]),
  ...
  { code: "4.04", label: "PIS", sign: "-", indent: 1 },
  { code: "4.05", label: "ICMS sobre Vendas", sign: "-", indent: 1 },
  { code: "4.06", label: "ISS", sign: "-", indent: 1 },
  { code: "4.07", label: "Outros Impostos", sign: "-", indent: 1 },
  ...
  { code: "302", label: "ICMS (compras)", sign: "-", auto_from: ["302"], indent: 1 },
  { code: "303", label: "Gás", sign: "-", auto_from: ["303"], indent: 1 },
  { code: "304", label: "Energia (produção)", sign: "-", auto_from: ["304"], indent: 1 },
  { code: "305", label: "Água (produção)", sign: "-", auto_from: ["305"], indent: 1 },

  // 5.07 Impostos sobre compras
  sub("5.07", "Custos (var) — Impostos sobre compras", ["5.07.01", "5.07.02", "5.07.03", "5.07.04", "5.07.05"]),
  { code: "5.07.01", label: "ICMS s/ compras", sign: "+", indent: 1 },
  { code: "5.07.02", label: "PIS s/ compras", sign: "+", indent: 1 },
  { code: "5.07.03", label: "COFINS s/ compras", sign: "+", indent: 1 },
  { code: "5.07.04", label: "Outros impostos s/ compras", sign: "+", indent: 1 },
  { code: "5.07.05", label: "Linha livre", sign: "+", indent: 1 },
  ...
  { code: "5.08.01", label: "Mão de Obra Própria", sign: "+", indent: 1 },
  { code: "5.08.02", label: "Provisão para 13º Salário", sign: "+", indent: 1 },
  { code: "5.08.03", label: "Provisão para Férias", sign: "+", indent: 1 },
  { code: "5.08.04", label: "FGTS", sign: "+", indent: 1 },
  { code: "5.08.05", label: "Provisão de FGTS (13° e Férias)", sign: "+", indent: 1 },
  { code: "5.08.06", label: "Provisão Multa Rescisória do FGTS", sign: "+", indent: 1 },
  { code: "5.08.08", label: "Provisão INSS (13° e Férias)", sign: "+", indent: 1 },
  ...
  { code: "5.10.01", label: "SALÁRIO BRUTO", sign: "+", indent: 1 },
  { code: "5.10.02", label: "Provisão para 13º Salário", sign: "+", indent: 1 },
  { code: "5.10.03", label: "Provisão para Férias", sign: "+", indent: 1 },
  { code: "5.10.04", label: "FGTS", sign: "+", indent: 1 },
  { code: "5.10.05", label: "Provisão de FGTS (13° e Férias)", sign: "+", indent: 1 },
  { code: "5.10.06", label: "Provisão Multa Rescisória do FGTS", sign: "+", indent: 1 },
  { code: "5.10.08", label: "Provisão INSS (13° e Férias)", sign: "+", indent: 1 },
  { code: "5.10.09", label: "Vale Transporte", sign: "+", indent: 1 },
  { code: "5.10.10", label: "Refeição", sign: "+", indent: 1 },
  { code: "5.10.11", label: "Cesta básica", sign: "+", indent: 1 },
  { code: "5.10.12", label: "Seguro de vida", sign: "+", indent: 1 },
  { code: "5.10.13", label: "Plano de saúde", sign: "+", indent: 1 },
  { code: "5.10.14", label: "Outros gastos com pessoal", sign: "+", indent: 1 },
  { code: "5.10.15", label: "Pró-labore bruto (valor recibo)", sign: "+", indent: 1 },
  { code: "5.10.16", label: "INSS empresa (sobre pró-labore)", sign: "+", indent: 1 },
  { code: "5.10.17", label: "Retirada complementar", sign: "+", indent: 1 },
  { code: "5.10.18", label: "Plano de saúde (sócios)", sign: "+", indent: 1 },
  { code: "5.10.19", label: "Retirada em produtos", sign: "+", indent: 1 },
  { code: "5.10.20", label: "Linha livre", sign: "+", indent: 1 },

  // 5.11 Veículos (produção)
  sub("5.11", "Custos c/ veículos (fix)", ["5.11.01", "5.11.02", "5.11.03", "5.11.04"]),
  { code: "5.11.01", label: "Combustível veículos", sign: "+", indent: 1 },
  { code: "5.11.02", label: "Manutenção veículos", sign: "+", indent: 1 },
  { code: "5.11.03", label: "Seguro veículos", sign: "+", indent: 1 },
  { code: "5.11.04", label: "IPVA + DPVAT + TRLAV", sign: "+", indent: 1 },
  ...
  { code: "5.12.01", label: "Água", sign: "+", indent: 1 },
  { code: "5.12.02", label: "Energia", sign: "+", indent: 1 },
  { code: "5.12.03", label: "Gás", sign: "+", indent: 1 },
  { code: "5.12.04", label: "Aluguéis", sign: "+", indent: 1 },
  { code: "5.12.05", label: "IPTU", sign: "+", indent: 1 },
  { code: "5.12.06", label: "Condomínios", sign: "+", indent: 1 },
  { code: "5.12.07", label: "Conservação de Bens / Instalações", sign: "+", indent: 1 },
  { code: "5.12.08", label: "Manutenção preventiva máquinas e equip.", sign: "+", indent: 1 },
  { code: "5.12.09", label: "Seguro de equipamentos", sign: "+", indent: 1 },
  { code: "5.12.10", label: "Depreciações ou Amortizações equip.", sign: "+", indent: 1 },
  { code: "5.12.11", label: "Outros Gastos", sign: "+", indent: 1 },

  // 6.00 Lucro Bruto
  sub("6.00", "Lucro Bruto", ["3.00", "-4.00", "-5.00"]),

  // 7.00 Despesas Variáveis com Vendas
  sub("7.00", "Despesas Variáveis c/ Vendas (var)", ["401", "402", "403", "498", "499"]),
  ...
  sub("10.00", "Despesas Fixas c/ Colaboradores (fix)", ["501", "502", "503", "599"]),
  ...
  sub("11.00", "Despesas c/ Concessionárias (fix)", ["11.01", "11.02", "11.03", "11.04", "11.05", "11.06"]),
  ...
  sub("12.00", "Despesas c/ veículos (fix)", ["12.01", "12.02", "12.03", "12.04"]),
  ...
  // 13.00 Marketing
  sub("13.00", "Despesas c/ marketing (fix)", ["13.01", "13.02", "13.03"]),
  ...
  // 17.00 Financeiras Fixas
  sub("17.00", "Despesas Financeiras Fixas (fix)", ["702", "703", "704", "799"]),
  ...
  // 18.00 Financeiras Variáveis
  sub("18.00", "Despesas Financeiras Variáveis (var)", ["18.01"]),
  { code: "18.01", label: "Outras (variáveis)", sign: "-", indent: 1 },

  // 19.00 Receitas Financeiras
  sub("19.00", "Receitas Financeiras", ["19.01"]),
  { code: "19.01", label: "Receitas financeiras / juros recebidos", sign: "+", indent: 1 },

  // 20.00 Lucro Antes do IR
  sub("20.00", "Lucro Antes do IR", ["16.00", "-17.00", "-18.00", "19.00"]),

  // 21.00 IRPJ / CSLL
  sub("21.00", "IRPJ / CSLL", ["21.01"]),
  { code: "21.01", label: "IRPJ / CSLL apurados", sign: "-", indent: 1 },

  // 22.00 Lucro Líquido
  sub("22.00", "Lucro Líquido", ["20.00", "-21.00"]),
];
...
export const DRE_HEADLINE_CODES = ["1.00", "3.00", "6.00", "16.00", "20.00", "22.00"] as const;
